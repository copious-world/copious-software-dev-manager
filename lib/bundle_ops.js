...
class BundleOps {
    ...
    async internal_publish_css(params,concerns_file_map) {
        ...
        let reports = []
        //
        let css_compressed_directory = params.compressed_src
        css_compressed_directory = this.absolute_path(css_compressed_directory)
        let copied_dir = css_storage_directory
        if ( params.compress ) {
            copied_dir = await this.ensure_compressed_css_exists(css_storage_directory,css_compressed_directory,reports)
        }
        //
        for ( let config_file in concerns_file_map ) {
            let concerns_table = concerns_file_map[config_file]
